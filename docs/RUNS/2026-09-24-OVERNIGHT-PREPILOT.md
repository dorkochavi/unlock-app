...
| F-13 | MANUAL UI VERIFIED, RESOLVED (2026-09-25 Production QA) |
| F-14 | RESOLVED LOCALLY (initial-load bug, automated tests); manual-verified only for answer-submit failure/retry (2026-09-25); initial-load manual verification NOT EXECUTED |

...
- Q6a framing protection — missing: framing test of an authenticated page with a live session. Owner: Claude, after the human provides an isolated test learner (same account as Q2-B/Q3). Smallest step: repeat the local iframe test with a session cookie present.
